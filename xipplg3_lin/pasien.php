    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container-fluid">
                <a href="a" class="navbar-brand">My App</a>
                ...
                <table class="table table-striped table-hover table-sm">
                    ...
                    while ($row = $hasil->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            href="koneksi.php?idPasien=<?= $row['idPasien']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Konfirmasi untuk menghapus?')">Hapus</a></td>
                        </tr>
                    <?php } ?>
                </table>
            </div>
